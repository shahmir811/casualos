    ...
    <form method="POST" action="{{ route('designs.update', $design) }}" enctype="multipart/form-data" class="card p-7 space-y-5">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4"
            ...
            <div>
                ...
                <input type="number" name="normal_price" value="{{ old('normal_price', $design->normal_price) }}" required min="0" step="0.01"
                    class="apple-input">
                @error('normal_price')
                    <p class="mt-1.5 text-[#FF3B30] text-xs">{{ $message }}</p>
                @enderror
            ...
            <div>
                ...
                <input type="number" name="discount_price" value="{{ old('discount_price', $design->discount_price) }}" min="0" step="0.01"
                    class="apple-input">
