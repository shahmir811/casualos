...
{{-- Stats Row --}}
<div class="grid grid-cols-2 lg:grid-cols-6 gap-4 mb-7">
    <div class="stat-card">
    ...
    <div class="stat-card">
        <p class="text-[#6E6E73] text-xs font-medium uppercase tracking-widest mb-1">Discount Benchmark</p>
        <p class="text-[#1D1D1F] text-2xl font-light">{{ $catalogue->quantity_benchmark !== null ? number_format($catalogue->quantity_benchmark) : '—' }}</p>
        <p class="text-[#86868B] text-xs mt-0.5">qty</p>
    </div>
    <div class="stat-card">
