...
<style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: Helvetica, Arial, sans-serif; font-size: 9px; color: #1D1D1F; background: #fff; }
    ...
    th { background: #F5F5F7; color: #6E6E73; font-size: 7.5px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.04em; padding: 5px 6px; border-bottom: 1px solid #D2D2D7; }
    th.right, td.right { text-align: right; }
    th.left, td.left { text-align: left; }
    td { padding: 5px 6px; border-bottom: 1px solid #E8E8ED; font-size: 8.5px; }
    tr:nth-child(even) td { background: #FAFAFA; }
    tfoot td { background: #F5F5F7 !important; font-weight: 700; font-size: 8.5px; border-top: 1.5px solid #D2D2D7; }
    .red { color: #DC2626; }
    .green { color: #16A34A; }
    .muted { color: #86868B; }
...
<div class="header">
    ...
    <p>Casual Lite — Per-customer bill, amount received, and outstanding balance</p>
