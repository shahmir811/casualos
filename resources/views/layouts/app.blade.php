...
<div class="flex min-h-screen">
    ...
    <aside id="sidebar"
        ...
        <nav class="px-3 py-2 space-y-0">
            ...
            <a href="{{ route('outsourced-batches.index') }}"
               class="nav-item {{ request()->routeIs('outsourced-batches.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-1.5 rounded-lg text-sm font-medium text-[#1D1D1F]">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('tarpai-charges.index') }}"
               class="nav-item {{ request()->routeIs('tarpai-charges.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-1.5 rounded-lg text-sm font-medium text-[#1D1D1F]">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('cron-logs.index') }}"
               class="nav-item {{ request()->routeIs('cron-logs.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-1.5 rounded-lg text-sm font-medium text-[#1D1D1F]">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('announcements.index') }}"
               class="nav-item {{ request()->routeIs('announcements.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-1.5 rounded-lg text-sm font-medium text-[#1D1D1F]">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('country-pricing.index') }}"
               class="nav-item {{ request()->routeIs('country-pricing.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-1.5 rounded-lg text-sm font-medium text-[#1D1D1F]">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
            ...
            <a href="{{ route('size-chart.index') }}"
               class="nav-item {{ request()->routeIs('size-chart.*') ? 'active' : '' }} flex items-center gap-3 px-3 py-1.5 rounded-lg text-sm font-medium text-[#1D1D1F]">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
