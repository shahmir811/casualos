    ...
    <div class="w-full max-w-sm">
        ...
        <div class="text-center mb-10">
            <div class="inline-flex items-center justify-center mb-5">
                <div class="w-16 h-16 rounded-2xl bg-[#0071E3] flex items-center justify-center shadow-lg">
                    <svg width="36" height="36" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="28" cy="28" r="18" stroke="white" stroke-width="2"/>
                        <line x1="36" y1="18" x2="36" y2="46" stroke="white" stroke-width="2"/>
                        <line x1="36" y1="46" x2="50" y2="46" stroke="white" stroke-width="2"/>
                    </svg>
                </div>
            </div>
            <h1 class="text-[#1D1D1F] font-semibold text-xl tracking-tight">Casualite</h1>
