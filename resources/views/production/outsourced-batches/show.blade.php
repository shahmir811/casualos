...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-1 space-y-4">
        ...
        <div class="stat-card text-center">
            ...
            <p class="text-3xl font-light text-[#1D1D1F]">{{ number_format($outsourcedBatch->items->sum('quantity')) }}</p>
                ...
                <table class="w-full apple-table">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t-2 border-[#E8E8ED] bg-[#F5F5F7]">
                            ...
                            <td class="px-5 py-2 text-right font-bold text-sm">{{ number_format($outsourcedBatch->items->sum('quantity')) }} pcs</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
