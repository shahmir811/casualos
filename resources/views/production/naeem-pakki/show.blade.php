...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-1 space-y-4">
        <div class="card p-5 space-y-4">
            ...
            <div>
                ...
                <p class="text-[#1D1D1F] font-medium">{{ $naeemPakkiSend->assignment?->design?->name ?? '—' }}</p>
            </div>
            <div>
                <p class="text-[#86868B] text-xs uppercase tracking-widest mb-1">Catalogue</p>
                <p class="text-[#1D1D1F]">{{ $naeemPakkiSend->assignment?->design?->catalogue?->name ?? '—' }}</p>
            </div>
            <div>
    ...
    <div class="lg:col-span-2 space-y-4">
            ...
            <table class="w-full apple-table">
                ...
                <tbody>
                    ...
                    <tr class="border-t-2 border-[#E8E8ED]">
                        ...
                        <td class="text-right font-bold">{{ $totalSent }} pcs</td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="card overflow-hidden">
            ...
            <table class="w-full apple-table">
                <thead><tr><th class="text-left">Return Date</th><th class="text-right">Total Pieces</th></tr></thead>
                <tbody>
