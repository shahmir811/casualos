...
class OrderAdjustController extends Controller
{
    ...
    public function store(Request $request, Order $order)
    {
        ...
        DB::transaction(function () use ($order, $qtyXS, $qtyS, $qtyM, $qtyL, $qtyXL) {
            ...
            foreach ($order->items as $item) {
                ...
                $item->qty_l  = $qtyL;
                $item->qty_xl = $qtyXL;
                $item->save(); // OrderItem::booted() auto-recomputes total_qty and total_amount
            ...
            activity()
                ...
                ->withProperties([
                    ...
                    'pieces_per_design' => $qtyXS + $qtyS + $qtyM + $qtyL + $qtyXL,
